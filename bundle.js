...
/***/ function(module, exports, __webpack_require__) {
	...
	var React           = __webpack_require__(2);
	var chargeCodeStore = __webpack_require__(6);
	...
	function render(){
	  var headings = this.state.headings.map(function(title, index){
	    return (
	      React.createElement("th", {key: title, className: "text-right"}, " ", title, " ")
	    )
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React           = __webpack_require__(2);
	var ChargeCodeStore = __webpack_require__(6);
	var TimeActions     = __webpack_require__(7);
	...
	function render(){
	  ...
	  return (
	    React.createElement("tr", null, 
	      React.createElement("td", {key: day.date, className: "text-right"}, " ", day.date, " "), 
	       actuals, 
	      React.createElement("td", {key: day.total, className: "text-right"}, " ", day.total, " ")
	    )
	  );
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dispatcher    = __webpack_require__(138).Dispatcher;
